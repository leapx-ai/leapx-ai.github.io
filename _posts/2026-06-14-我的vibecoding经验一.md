...
![alt text](/assets/img/image3233.png)
...
我之前提到过[《harness:即使错了也能被修正的系统》](https://mp.weixin.qq.com/s/iRS5bqCuW2wa4YiVmz3gog)，模型是不确定性的，但我们要求任务的结果是确定的，harness的核心就是如何做到用不确定的能力稳定实现确定性的结果，它是一个工程能力，其核心实现方式便是创建一个“调节回路”；

什么是调节回路

当系统内的某个变量偏离了预设的目标（或平衡点）时，调节回路会自动启动，施加反向作用力，把变量拉回正轨。

如果你是一个“yes工程师”，也就是说你用ai编程已经到了只需要点击确认下一步的程度，那你肯定有基线约束，有审计，有循环，甚至可以开启一个自动的循环来展开工作。
